...
.. image:: img/nucleo_l073rzlocal.jpg
   :align: center
   :alt: Nucleo L073RZ
...
The Zephyr nucleo_l073rzlocal board configuration supports the following hardware features:
...
``boards/arm/nucleo_l073rzlocal/nucleo_l073rzlocal_defconfig``
...
Board connectors:
-----------------
.. image:: img/nucleo_l073rzlocal_connectors.jpg
   :align: center
...
Applications for the ``nucleo_l073rzlocal`` board configuration can be built and
